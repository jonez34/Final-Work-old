...
$check = mysqli_query($con, "SELECT username FROM login WHERE username = '$usercheck'") 
or die(mysqli_error());
...
$sql = "INSERT INTO login (name, emailaddress, username, password) VALUES ('$name', '$emailaddress', '$username', '$password')"; 
